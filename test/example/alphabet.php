<?php include 'backend/Core.php';
    ...
    //Get video
    $url = Core::getInstance()->api.'/video/post/data/public/show/alphabet/'.$page.'/'.$itemsperpage.'/?apikey='.Core::getInstance()->apikey;
    ...
    $title = Core::lang('alphabet_list').(!empty($page) && ($page != 1)?' | '.Core::lang('page').' '.$page:'').' | '.Core::getInstance()->title;
    $description = Core::lang('alphabet_list').'. '.Core::lang('genre_desc_1').(!empty($page)?' '.Core::lang('page').' '.$page:'');
    $keyword = Core::lang('alphabet_key_1');
            ...
            <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-lg-10 col-sm-10 col-xs-8">
                                <ul class="list-inline">
                                    <li class="color-active"><h1 style="font-size: 20px !important;"><strong><?php echo Core::lang('alphabet_list')?></strong></h1></li>
                                </ul>
                            </div>
                ...
                <?php
                    if (!empty($data) && ($data->{'status'} == "success")){
                        ...
                        echo $pagination->makePaginationFrontend($data,$_SERVER['PHP_SELF'].'?show=alphabet');
                    }
                ?>
