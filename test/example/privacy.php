...
<head>
    ...
    <meta name="description" content="<?php echo Core::lang('privacy')?>">
    <meta name="keyword" content="<?php echo Core::lang('privacy')?>, <?php echo Core::getInstance()->keyword?>"?>
    <meta name="author" content="<?php echo Core::getInstance()->title.' Team'?>">

    <title><?php echo Core::lang('privacy')?> | <?php echo Core::getInstance()->title?></title>
