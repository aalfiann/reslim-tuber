                              ...
                              <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label>Country</label>
                                            <input id="country-imdb" name="country" type="text" placeholder="Input the country name separated with comma here..." maxlength="100" class="form-control border-input" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
